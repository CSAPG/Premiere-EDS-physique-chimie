...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (panel0) {
    panel0.innerHTML = `
      ...
      <a class="pre-resource-link" href="seq00/sequence00_cours.html" target="_blank" style="margin-bottom:16px;">
        <div class="pre-res-icon">💻</div>
        <div>
          <p class="pre-res-label">Cours interactif</p>
          <p class="pre-res-sub">Version en ligne animée de la Séquence 00</p>
        </div>
        <div class="pre-res-cta">↗</div>
      </a>
      <a class="pre-resource-link" href="seq00/sequence00_cours.pdf" target="_blank" style="margin-bottom:16px;">
        <div class="pre-res-icon">📄</div>
        <div>
          <p class="pre-res-label">Cours en PDF</p>
          <p class="pre-res-sub">Version imprimable de la Séquence 00</p>
        </div>
        <div class="pre-res-cta">↓</div>
      </a>
    `;
  ...
  if (panel1) {
    panel1.innerHTML = `
      ...
      <a class="pre-resource-link" href="seq01/sequence01_cours.html" target="_blank" style="margin-bottom:16px;">
        <div class="pre-res-icon">💻</div>
        <div>
          <p class="pre-res-label">Cours interactif</p>
  ...
  const panel2 = document.getElementById('premiere-seq-2');
  if (panel2) {
    panel2.innerHTML = `
      <div class="pre-panel-header">
      ...
      <a class="pre-resource-link" href="seq02/sequence02_cours.html" target="_blank" style="margin-bottom:16px;">
        <div class="pre-res-icon">💻</div>
        <div>
          <p class="pre-res-label">Cours interactif</p>
  ...
  // Séquences 03 à 14 : panneaux prêts, titre provisoire, icône à ajouter dès réception du fichier
  for (let n = 3; n <= 14; n++) {
